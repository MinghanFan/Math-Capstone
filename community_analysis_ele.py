...
#Input files
#original edge file
EDGE_FILE = root + "data/elegan_edges.csv"
#gephi file
GEPHI_NODE_FILE = root + "data/elegan_gephi.csv"
#closeness list
OUTPUT_ALL = root + "elegan_result/elegan_RWC_all.csv"
# Classic centrality stats
CLASSIC_STATS_FILE = root + "elegan_result/elegan_classic.csv"
# Random-walk betweenness
RW_BETWEENNESS_FILE = root + "elegan_result/elegan_RWB.csv"


# Outputs files
MERGED_OUTPUT = root + "elegan_result/elegan_ALL.csv"
COMMUNITY_SUMMARY_OUTPUT = root + "community/elegan_community.csv"
